...
CATECISMO = {
    "I. A Profissao da Fe (O Credo)": [
        ("Par. 26", "Deus vem ao encontro do homem. A fé cristã não é antes de tudo um conjunto de verdades a crer, mas um encontro com uma Pessoa viva: Jesus Cristo."),
        ("Par. 27", "O desejo de Deus esta inscrito no coração do homem, porque o homem foi criado por Deus e para Deus. Deus não cessa de atrair o homem para Si."),
        ...
        ("Par. 150", "A fe é antes de tudo uma adesão pessoal do homem a Deus; e ao mesmo tempo, é inseparável disso, o assentimento livre a toda a verdade que Deus revelou."),
        ("Par. 153", "A fe é um dom de Deus, uma virtude sobrenatural infundida por Ele. Para que esta fé éxista, são necessários a graça preveniente e a ajuda interior do Espirito Santo."),
        ("Par. 166", "A fe é um ato pessoal: a resposta livre do homem a iniciativa de Deus que se revela. Mas a fe não é um ato isolado. Ninguem pode crer sozinho."),
        ("Par. 185", "Credo — eu creio. Este simbolo e uma sintese da nossa fe. As primeiras comunidades cristas formularam profissoes de fe breves para exprimir sua adesão a Cristo."),
        ("Par. 198", "Nossa profissao de fe comeca por Deus, pois Deus e o Primeiro e o Ultimo, o Principio e o Fim de tudo."),
        ("Par. 232", "Os cristaos são batizados em nome do Pai e do Filho e do Espirito Santo."),
        ("Par. 234", "O misterio da Santissima Trindade e o misterio central da fé é da vida crista."),
        ("Par. 422", "O Filho de Deus se fez homem para nos salvar. A Encarnacao é a verdade central da fé cristã."),
        ("Par. 638", "A Ressurreicao de Cristo é a verdade culminante da nossa fé ém Cristo."),
        ("Par. 668", "Cristo morreu e voltou a vida para ser Senhor tanto dos mortos como dos vivos."),
        ("Par. 683", "O Espirito Santo e enviado para santificar e vivificar a Igreja."),
        ("Par. 748", "Cristo e a luz das nacoes. Esta luz de Cristo brilha no rosto da Igreja."),
        ("Par. 988", "O dogma crista da ressurreição dos mortos e uma verdade essencial da fé."),
        ("Par. 1020", "O cristao que une sua própria morte a de Jesus encarece nela a plenitude do misterio pascal."),
        ("Par. 1023", "Os que morrem na graça e na amizade de Deus e estao perfeitamente purificados vivem para sempre com Cristo."),
    ],
    "II. A Celebracao do Misterio Crista (Os Sacramentos)": [
        ("Par. 1066", "Na liturgia da Igreja, Cristo significa e realiza principalmente Seu misterio pascal."),
        ("Par. 1113", "Toda a vida liturgica da Igreja gira em torno do sacrificio eucaristico e dos sacramentos. Ha na Igreja sete sacramentos."),
        ("Par. 1127", "Os sacramentos são eficazes porque neles age o próprio Cristo."),
        ("Par. 1213", "O santo Batismo é o fundamento de toda a vida crista, o portico da vida no Espirito."),
        ("Par. 1244", "A imersao na agua simboliza o sepultamento com Cristo. Sair da agua e como a ressurreição com Cristo."),
        ("Par. 1285", "Com o Batismo e a Eucaristia, o sacramento da Crisma constitui o conjunto dos sacramentos da inicacao crista."),
        ("Par. 1322", "A sagrada Eucaristia conclui a inicacao crista."),
        ("Par. 1324", "A Eucaristia é a fonte e o apice de toda a vida crista."),
        ("Par. 1339", "Jesus escolheu o momento da Pascoa para realizar o que havia anunciado em Cafarnau: dar a Seus discipulos Seu Corpo e Seu Sangue."),
        ("Par. 1422", "Os que se aproximam do sacramento da Penitencia obtem da misericórdia de Deus o perdoao das ofensas feitas a Ele."),
        ("Par. 1446", "Cristo instituiu o sacramento da Penitencia para todos os membros pecadores de Sua Igreja."),
        ("Par. 1499", "Pela santa Uncao dos Enfermos e pela oração dos sacerdotes, a Igreja toda confia os doentes ao Senhor sofredor e glorificado."),
        ("Par. 1601", "A alianca matrimonial, pela qual o homem e a mulher constituem entre si uma intima comunhao de vida e de amor, foi fundada pelo Criador."),
    ],
    "III. A Vida em Cristo (Os Mandamentos)": [
        ("Par. 1691", "Cristao, conhece tua dignidade. Tornaste-te participe da natureza divina."),
        ("Par. 1700", "A dignidade da pessoa humana tem seu fundamento na sua criação a imagem e semelhanca de Deus."),
        ("Par. 1730", "Deus criou o homem racional e, por conseguinte, livre."),
        ("Par. 1776", "A consciencia moral e um juizo da razao pelo qual a pessoa humana reconhece a qualidade moral dé um ato."),
        ("Par. 1803", "Uma virtude e uma disposicao habitual e firme para fazer o bem."),
        ("Par. 1822", "A caridade e a virtude teologal pela qual amamos a Deus sobre todas as coisas."),
        ("Par. 1849", "O pecado e uma falta contra a razao, a verdade, a consciencia reta."),
        ("Par. 1855", "O pecado mortal destroi a caridade no coração do homem pelo grave desprezo de Deus."),
        ("Par. 1968", "A lei evangelica cumpre, purifica, supera e eleva a lei antiga."),
        ("Par. 2052", "Jesus resume os mandamentos dizendo: Deves amar ao Senhor teu Deus com todo o teu coração."),
        ("Par. 2083", "Jesus resumiu as obrigacoes do homem para com Deus no mandamento de amar a Deus de todo o coração."),
        ("Par. 2258", "A vida humana e sagrada porque, desde a sua origem, importa a acao criadora de Deus e permanece para sempre em relacao especial com o Criador."),
    ],
    "IV. A Oração Crista": [
        ("Par. 2558", "O grande drama da oração e perseverarmos nela ate o fim e acreditarmos na eficacia da oração."),
        ("Par. 2559", "A oração é a elevação da alma a Deus ou o pedido a Deus de bens conformes com a Sua vontade."),
        ("Par. 2566", "Deus chama o homem primeiro. Quer o homem se esqueca do seu Criador ou se esconda d'Ele, o Deus vivo e verdadeiro não cessa de chamar cada pessoa ao encontro misterioso da oração."),
        ("Par. 2590", "O profeta eleva sua oração a Deus e intercede por ele. A oração profética e intercessao."),
        ("Par. 2607", "Jesus ora diante dos momentos decisivos de Sua missao: antes do Seu Batismo e da Sua transfiguracao."),
        ("Par. 2623", "A Igreja comunica a seus filhos as formas de oração: a bencao e a adoração, a peticao, a intercessao, a acao de graças e o louvor."),
        ("Par. 2650", "A oração não se reduz ao jorro espontaneo de um impulso interior: para orar, é preciso querer orar."),
        ("Par. 2697", "A oração é a vida do coração novo. Deve animar-nos em todo momento."),
        ("Par. 2759", "Jesus nos ensinou a orar, respondendo ao pedido de um de Seus discipulos: Senhor, ensina-nos a orar."),
        ("Par. 2765", "A oração dominical e verdadeiramente a sintese de todo o Evangelho."),
        ("Par. 2777", "Ao dizer Pai Nosso, Jesus nos revela que Deus e verdadeiramente Pai e que somos verdadeiramente Seus filhos."),
        ("Par. 2803", "Depois de nos colocarmos sob a presenca de Deus e de o adorarmos, o Espirito de adocao suscita em nossos coracoes sete pedidos, sete bencaos."),
        ("Par. 2827", "Seja feita a Tua vontade assim na terra como no Ceu."),
        ("Par. 2850", "O ultimo pedido do Pai Nosso e também levado na oração de Jesus ao Pai. Livrai-nos do Mal."),
        ("Par. 2856", "No fim da oração dominical, ha uma doxologia: Teu e o reino, o poder e a gloria, para sempre."),
    ],
}
...
CREDITOS = {
    "criador": "Pedro",
    "criador_desc": "Desenvolvedor e idealizador do Virtual Catholics, movido pela fe catolica e pelo desejo de levar a fe digital a todos os cristaos.",
    "agradecimento_nome": "Joao Lucas",
    "agradecimento_desc": "Amigo e colaborador que contribuiu com ideias fundamentais para o desenvolvimento do projeto.",
    "dedicatoria": "A Deus, a Nossa Senhora e a todos os cristaos que buscam fortalecer sua fe no mundo digital.",
    "email": "virtualcatholics@gmail.com",
    "versao": "Virtual Catholics © 2025 — Feito com fe e amor",
