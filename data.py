...
CATECISMO = {
    "I. A Profissao da Fe (O Credo)": [
        ("Par. 26", "Deus vem ao encontro do homem. A fe crista nao e antes de tudo um conjunto de verdades a crer, mas um encontro com uma Pessoa viva: Jesus Cristo."),
        ...
        ("Par. 232", "Os cristaos sao batizados em nome do Pai e do Filho e do Espirito Santo."),
        ("Par. 234", "O misterio da Santissima Trindade e o misterio central da fe e da vida crista."),
        ("Par. 422", "O Filho de Deus se fez homem para nos salvar. A Encarnacao e a verdade central da fe crista."),
        ("Par. 638", "A Ressurreicao de Cristo e a verdade culminante da nossa fe em Cristo."),
        ...
        ("Par. 988", "O dogma crista da ressurreicao dos mortos e uma verdade essencial da fe."),
        ("Par. 1020", "O cristao que une sua propria morte a de Jesus encarece nela a plenitude do misterio pascal."),
        ("Par. 1023", "Os que morrem na graca e na amizade de Deus e estao perfeitamente purificados vivem para sempre com Cristo."),
    ],
    "II. A Celebracao do Misterio Crista (Os Sacramentos)": [
        ...
        ("Par. 1127", "Os sacramentos sao eficazes porque neles age o proprio Cristo."),
        ("Par. 1213", "O santo Batismo e o fundamento de toda a vida crista, o portico da vida no Espirito."),
        ("Par. 1244", "A imersao na agua simboliza o sepultamento com Cristo. Sair da agua e como a ressurreicao com Cristo."),
        ...
        ("Par. 1324", "A Eucaristia e a fonte e o apice de toda a vida crista."),
        ...
        ("Par. 1422", "Os que se aproximam do sacramento da Penitencia obtem da misericordia de Deus o perdoao das ofensas feitas a Ele."),
        ("Par. 1446", "Cristo instituiu o sacramento da Penitencia para todos os membros pecadores de Sua Igreja."),
        ("Par. 1499", "Pela santa Uncao dos Enfermos e pela oracao dos sacerdotes, a Igreja toda confia os doentes ao Senhor sofredor e glorificado."),
    ...
    "III. A Vida em Cristo (Os Mandamentos)": [
        ...
        ("Par. 1700", "A dignidade da pessoa humana tem seu fundamento na sua criacao a imagem e semelhanca de Deus."),
        ("Par. 1730", "Deus criou o homem racional e, por conseguinte, livre."),
        ("Par. 1776", "A consciencia moral e um juizo da razao pelo qual a pessoa humana reconhece a qualidade moral de um ato."),
        ...
        ("Par. 1855", "O pecado mortal destroi a caridade no coracao do homem pelo grave desprezo de Deus."),
        ("Par. 1968", "A lei evangelica cumpre, purifica, supera e eleva a lei antiga."),
        ("Par. 2052", "Jesus resume os mandamentos dizendo: Deves amar ao Senhor teu Deus com todo o teu coracao."),
        ("Par. 2083", "Jesus resumiu as obrigacoes do homem para com Deus no mandamento de amar a Deus de todo o coracao."),
    ...
    "IV. A Oracao Crista": [
        ("Par. 2558", "O grande drama da oracao e perseverarmos nela ate o fim e acreditarmos na eficacia da oracao."),
        ("Par. 2559", "A oracao e a elevacao da alma a Deus ou o pedido a Deus de bens conformes com a Sua vontade."),
        ("Par. 2566", "Deus chama o homem primeiro. Quer o homem se esqueca do seu Criador ou se esconda d'Ele, o Deus vivo e verdadeiro nao cessa de chamar cada pessoa ao encontro misterioso da oracao."),
        ("Par. 2590", "O profeta eleva sua oracao a Deus e intercede por ele. A oracao profética e intercessao."),
        ...
        ("Par. 2650", "A oracao nao se reduz ao jorro espontaneo de um impulso interior: para orar, e preciso querer orar."),
        ("Par. 2697", "A oracao e a vida do coracao novo. Deve animar-nos em todo momento."),
        ("Par. 2759", "Jesus nos ensinou a orar, respondendo ao pedido de um de Seus discipulos: Senhor, ensina-nos a orar."),
        ("Par. 2765", "A oracao dominical e verdadeiramente a sintese de todo o Evangelho."),
        ...
        ("Par. 2850", "O ultimo pedido do Pai Nosso e tambem levado na oracao de Jesus ao Pai. Livrai-nos do Mal."),
        ("Par. 2856", "No fim da oracao dominical, ha uma doxologia: Teu e o reino, o poder e a gloria, para sempre."),
    ],
}
